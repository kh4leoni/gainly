-- =====================================================================
-- Offline sync: add tombstone support for set_logs deletions.
-- New optional 4th arg p_deleted_set_ids (uuid[]) — server deletes those
-- rows. RLS already permits the client to delete their own set_logs via
-- the workout_logs.client_id check.
-- =====================================================================

drop function if exists public.upsert_workout_with_sets(jsonb, jsonb, jsonb);
...
begin
  ...
  -- 2d. Delete tombstoned set_logs (RLS enforced).
