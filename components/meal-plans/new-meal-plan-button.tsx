...
import { createMealPlan } from "@/lib/queries/meals";
...
export function NewMealPlanButton({ clientId }: { clientId?: string | null }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Lisää ruokaohjelma</DialogTitle>
          <DialogDescription>Luo uusi malliruokaohjelma. Henkilökohtaiset luodaan asiakkaan sivulta.</DialogDescription>
        </DialogHeader>
